package com.syedzulqarnainsapplication.app.modules.editvaccinationrecordstep2selectedtwentynine.`data`.model

import com.syedzulqarnainsapplication.app.R
import com.syedzulqarnainsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class EditVaccinationRecordStep2SelectedTwentynineModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var etDateValue: String? = MyApp.getInstance().resources.getString(R.string.lbl_25_12_2021)
