package com.syedzulqarnainsapplication.app.modules.editvaccinationrecordstep2selectedtwentyfour.`data`.model

import com.syedzulqarnainsapplication.app.R
import com.syedzulqarnainsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class EditVaccinationRecordStep2SelectedTwentyfourModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTextbartoolc: String? = MyApp.getInstance().resources.getString(R.string.lbl_yes_now)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTextbartoolcOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_yes_later)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTextbartoolcTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_no)
  ,
  /**
   * TODO Replace with dynamic value
   */
  ...
  var etTextTwoValue: String? =
      MyApp.getInstance().resources.getString(R.string.msg_fear_of_fever_a3)
